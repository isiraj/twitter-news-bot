...
def send_mail(tweets):
    ...
    server.sendmail('imran.siraj6450@gmail.com', 'isiraj7289@bths.edu', message.encode('ascii', 'ignore')) # The email with the tweets will be sent from my personal email to my school email.
...
stream.filter(follow = ['428333', '807095', '2467791'], track = ['President Trump'], languages = ['en']) # This will filter the stream of tweets. I will only get tweet that contain the words 'President Trump' as he popular on the news currently.
